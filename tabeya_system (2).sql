...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2025 at 03:32 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DeductIngredientsForPOSOrder` (IN `p_order_id` INT)   BEGIN
    ...
    DECLARE v_quantity_per_serving DECIMAL(10,2);
    DECLARE v_total_to_deduct DECIMAL(10,2);
    DECLARE v_batch_id INT;
    DECLARE v_batch_stock DECIMAL(10,2);
    DECLARE v_remaining_to_deduct DECIMAL(10,2);
    ...
    -- REMOVED: START TRANSACTION (triggers handle transactions automatically)
    
    OPEN order_cursor;
    
    order_loop: LOOP
        FETCH order_cursor INTO v_product_name, v_quantity;
        ...
        FROM products
        WHERE ProductName = v_product_name
        LIMIT 1;
        
        IF v_product_id IS NOT NULL THEN
            -- Get ingredients for this product
            BEGIN
                DECLARE done_ingredients INT DEFAULT FALSE;
                DECLARE ingredient_cursor CURSOR FOR
                    SELECT pi.IngredientID, pi.QuantityUsed
                    FROM product_ingredients pi
                    WHERE pi.ProductID = v_product_id;
                
                DECLARE CONTINUE HANDLER FOR NOT FOUND SET done_ingredients = TRUE;
                
                OPEN ingredient_cursor;
                
                ingredient_loop:LOOP
                    FETCH ingredient_cursor INTO v_ingredient_id, v_quantity_per_serving;
                    
                    IF done_ingredients THEN
                        LEAVE ingredient_loop;
                    END IF;
                    
                    -- Calculate total to deduct
                    SET v_total_to_deduct = v_quantity_per_serving * v_quantity;
                    SET v_remaining_to_deduct = v_total_to_deduct;
                    
                    -- Deduct from batches (FIFO - oldest first)
                    BEGIN
                        DECLARE done_batches INT DEFAULT FALSE;
                        ...
                        DECLARE CONTINUE HANDLER FOR NOT FOUND SET done_batches = TRUE;
                        
                        OPEN batch_cursor;
                        
                        batch_loop: LOOP
                            FETCH batch_cursor INTO v_batch_id, v_batch_stock;
                            
                            IF done_batches OR v_remaining_to_deduct <= 0 THEN
                                LEAVE batch_loop;
                            END IF;
                            
                            IF v_batch_stock >= v_remaining_to_deduct THEN
                                -- This batch has enough stock
                                UPDATE inventory_batches
                                SET StockQuantity = StockQuantity - v_remaining_to_deduct,
                                    UpdatedDate = NOW()
                                WHERE BatchID = v_batch_id;
                                
                                -- Mark as depleted if stock reaches 0
                                UPDATE inventory_batches
                                ...
                                SELECT p_order_id, oi.OrderItemID, v_batch_id, v_ingredient_id, 
                                       v_remaining_to_deduct, pi.UnitType
                                FROM order_items oi
                                JOIN product_ingredients pi ON pi.ProductID = v_product_id 
                                    AND pi.IngredientID = v_ingredient_id
                                WHERE oi.OrderID = p_order_id 
                                AND oi.ProductName = v_product_name
                                LIMIT 1;
                                
                                SET v_remaining_to_deduct = 0;
                            ELSE
                                -- Use all stock from this batch and continue
                                SET v_remaining_to_deduct = v_remaining_to_deduct - v_batch_stock;
    ...
    UPDATE products p
    INNER JOIN order_items oi ON p.ProductName = oi.ProductName
    SET p.OrderCount = p.OrderCount + oi.Quantity
    WHERE oi.OrderID = p_order_id;
    
    -- REMOVED: COMMIT (triggers handle commits automatically)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `IncrementCustomerOrderCount` (IN `p_customer_id` INT)   BEGIN
    -- Update the customer's total orders count
    UPDATE customers 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `RecordIngredientUsage` (IN `p_inventory_id` INT, IN `p_quantity_used` DECIMAL(10,2), IN `p_reference_id` VARCHAR(50))   BEGIN
    ...
    UPDATE inventory 
    SET StockQuantity = StockQuantity - p_quantity_used,
        UpdatedDate = NOW()
    WHERE InventoryID = p_inventory_id;
    
    -- Optional: Log the usage (if you have an ingredient_usage_log table)
    -- INSERT INTO ingredient_usage_log (InventoryID, QuantityUsed, ReferenceID, UsageDate)
    -- VALUES (p_inventory_id, p_quantity_used, p_reference_id, NOW());
...
--
-- Stand-in structure for view `approved_feedback_view`
-- (See below for the actual view)
--
CREATE TABLE `approved_feedback_view` (
`FeedbackID` int(10)
,`CustomerID` int(10)
,`DisplayName` varchar(53)
,`OrderID` int(10)
,`ReservationID` int(10)
,`FeedbackType` enum('Order','Reservation','General')
...
(0, 426, 'Usage', -50.00, 50.00, 0.00, 'RES-11', 'System', 'Reservation Confirmed', 'Deducted for reservation #11 - Beef Teriyaki w/ Egg (Rice Meal) (1 units) by Ronald Sevillaaaaee', '2025-12-06 01:08:01'),
(0, 469, 'Usage', -15.00, 50.00, 35.00, 'RES-11', 'System', 'Reservation Confirmed', 'Deducted for reservation #11 - Beef Teriyaki w/ Egg (Rice Meal) (1 units) by Ronald Sevillaaaaee', '2025-12-06 01:08:01'),
(0, 445, 'Usage', -10.00, 40.00, 30.00, 'RES-11', 'System', 'Reservation Confirmed', 'Deducted for reservation #11 - Beef Teriyaki w/ Egg (Rice Meal) (1 units) by Ronald Sevillaaaaee', '2025-12-06 01:08:01'),
(0, 436, 'Usage', -1.00, 50.00, 49.00, 'RES-11', 'System', 'Reservation Confirmed', 'Deducted for reservation #11 - Beef Teriyaki w/ Egg (Rice Meal) (1 units) by Ronald Sevillaaaaee', '2025-12-06 01:08:01'),
(0, 439, 'Usage', -50.00, 50.00, 0.00, 'RES-11', 'System', 'Reservation Confirmed', 'Deducted for reservation #11 - Beef Teriyaki w/ Egg (Rice Meal) (1 units) by Ronald Sevillaaaaee', '2025-12-06 01:08:01'),
(0, 436, 'Usage', -1.00, 49.00, 48.00, 'RES-11', 'System', 'Reservation Confirmed', 'Deducted for reservation #11 - Breaded Chicken w/ Egg (Rice Meal) (1 units) by Ronald Sevillaaaaee', '2025-12-06 01:08:01'),
(0, 541, 'Usage', -1.00, 50.00, 49.00, 'ORD-1007', 'POS User', 'POS Order', 'Deducted for order #1007 - Bucket of Six (Beers) (1 units) by POS User', '2025-12-06 01:50:58'),
(0, 430, 'Usage', -50.00, 50.00, 0.00, 'RES-13', 'System', 'Reservation Confirmed', 'Deducted for reservation #13 - Beef Tapa w/ Egg (Rice Meal) (1 units) by Ronald Sevillaaaaee', '2025-12-08 12:50:40'),
(0, 436, 'Usage', -1.00, 48.00, 47.00, 'RES-13', 'System', 'Reservation Confirmed', 'Deducted for reservation #13 - Beef Tapa w/ Egg (Rice Meal) (1 units) by Ronald Sevillaaaaee', '2025-12-08 12:50:40');
...
CREATE TABLE `customer_feedback` (
  `FeedbackID` int(10) NOT NULL COMMENT 'Unique feedback identifier',
  `CustomerID` int(10) NOT NULL COMMENT 'Reference to customer who submitted feedback',
  `OrderID` int(10) DEFAULT NULL COMMENT 'If feedback is for an order',
  `ReservationID` int(10) DEFAULT NULL COMMENT 'If feedback is for a reservation',
  `FeedbackType` enum('Order','Reservation','General') NOT NULL DEFAULT 'General' COMMENT 'Type of feedback',
  `OverallRating` decimal(2,1) NOT NULL COMMENT 'Overall rating (1.0-5.0)',
  ...
  `ServiceRating` int(1) DEFAULT NULL COMMENT 'Customer service rating (1-5)',
  ...
  `ServiceComment` text DEFAULT NULL COMMENT 'Comment about customer service',
  ...
  `ReviewMessage` text DEFAULT NULL COMMENT 'General review message',
  `IsAnonymous` tinyint(1) DEFAULT 0 COMMENT '0 = show name, 1 = hide name',
  `Status` enum('Pending','Approved','Rejected') DEFAULT 'Pending' COMMENT 'Review approval status',
  `CreatedDate` datetime DEFAULT current_timestamp() COMMENT 'Feedback submission date',
  `ApprovedDate` datetime DEFAULT NULL COMMENT 'Date when feedback was approved',
...
INSERT INTO `customer_feedback` (`FeedbackID`, `CustomerID`, `OrderID`, `ReservationID`, `FeedbackType`, `OverallRating`, `FoodTasteRating`, `PortionSizeRating`, `ServiceRating`, `AmbienceRating`, `CleanlinessRating`, `FoodTasteComment`, `PortionSizeComment`, `ServiceComment`, `AmbienceComment`, `CleanlinessComment`, `ReviewMessage`, `IsAnonymous`, `Status`, `CreatedDate`, `ApprovedDate`, `UpdatedDate`) VALUES
(1, 2, NULL, NULL, 'General', 4.0, 4, 4, 4, 4, 4, 'dadwa', 'dawdw', 'wdawda', 'wdawda', 'wdawd', 'wdwr32eaf', 1, 'Approved', '2025-12-06 01:00:34', '2025-12-06 01:17:08', '2025-12-06 01:17:08'),
(2, 2, NULL, 11, 'Reservation', 4.0, 3, 4, 4, 4, 4, 'thfghf', 'terte', 'ertert', 'terte', 'ertert', 'eterter', 1, 'Approved', '2025-12-06 01:08:42', '2025-12-06 01:16:06', '2025-12-06 01:16:06'),
(3, 2, NULL, NULL, 'General', 4.0, 3, 4, 4, 4, 4, 'ewewerwq3', '3qar3a', '3rwq4r34', 'ar2432432', '34423423', '34fdfsdfs', 0, 'Approved', '2025-12-06 01:18:13', '2025-12-06 01:21:37', '2025-12-06 01:21:37');

--
-- Triggers `customer_feedback`
--
DELIMITER $$
CREATE TRIGGER `after_feedback_approved` AFTER UPDATE ON `customer_feedback` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_satisfaction_from_feedback` AFTER UPDATE ON `customer_feedback` FOR EACH ROW BEGIN
...
CREATE TABLE `employee_attendance` (
  `AttendanceID` int(10) NOT NULL COMMENT 'Unique attendance record identifier',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Employee attendance and time tracking records';

--
-- Dumping data for table `employee_attendance`
--

INSERT INTO `employee_attendance` (`AttendanceID`, `EmployeeID`, `AttendanceDate`, `TimeIn`, `TimeOut`, `Status`, `WorkHours`, `Notes`, `CreatedAt`, `UpdatedAt`) VALUES
(1, 5, '2025-12-04', '2025-12-04 23:38:58', '2025-12-04 23:48:51', 'Present', 0.16, NULL, '2025-12-04 23:38:58', '2025-12-04 23:48:52'),
(2, 1, '2025-12-08', '2025-12-08 12:05:00', NULL, 'Present', NULL, NULL, '2025-12-08 12:05:00', '2025-12-08 12:05:00'),
(3, 5, '2025-12-09', '2025-12-09 21:16:09', NULL, 'Present', NULL, NULL, '2025-12-09 21:16:09', '2025-12-09 21:16:09'),
(4, 5, '2025-12-10', '2025-12-10 06:57:41', NULL, 'Present', NULL, NULL, '2025-12-10 06:57:41', '2025-12-10 06:57:41'),
(5, 5, '2025-12-14', '2025-12-14 21:41:10', NULL, 'Present', NULL, NULL, '2025-12-14 21:41:10', '2025-12-14 21:41:10');
...
(12, 'Beef', 1, 'kg', 0.00, '2025-11-29 16:42:20', '2025-11-27', 'For bulalo and kare-kare', 5.00, 100.00, 1, 1, NULL),
...
(16, 'Tapa Meat', 1, 'kg', 0.00, '2025-11-29 16:42:20', '2025-11-30', 'Pre-marinated beef', 5.00, 100.00, 1, 1, NULL),
...
(22, 'Eggs', 3, 'tray', 0.00, '2025-11-29 16:42:21', '2025-12-05', '30 pcs per tray', 5.00, 100.00, 1, 1, NULL),
...
(25, 'Rice', 4, 'kg', 0.00, '2025-11-29 16:42:21', '2026-05-19', 'Sinandomeng variety', 5.00, 100.00, 1, 1, NULL),
...
(31, 'Onion', 2, 'kg', 30.00, '2025-11-29 16:42:21', '2025-12-05', 'Red onion preferred', 5.00, 100.00, 1, 1, NULL),
...
(55, 'Soy Sauce', 5, 'liter', 35.00, '2025-11-29 16:42:22', '2026-05-15', 'Silver Swan brand', 5.00, 100.00, 1, 1, NULL),
...
(148, 'Beer Bucket (6 Bottles)', 7, 'bucket', 49.00, '2025-11-29 16:42:26', NULL, NULL, 5.00, 100.00, 1, 1, NULL);
...
(426, 12, 'BEE-20251129-001', 0.00, 50.00, 'kg', 27.12, '2025-11-29 16:42:20', '2025-12-16', '', 'Depleted', 'Auto-generated batch', '2025-11-29 16:42:20', '2025-12-06 01:08:01'),
...
(430, 16, 'TAP-20251129-001', 0.00, 50.00, 'kg', 11.42, '2025-11-29 16:42:20', '2025-12-23', '', 'Depleted', 'Auto-generated batch', '2025-11-29 16:42:20', '2025-12-08 12:50:40'),
...
(436, 22, 'EGG-20251129-001', 47.00, 50.00, 'tray', 42.37, '2025-11-29 16:42:21', '2025-12-08', '', 'Expired', 'Auto-generated batch', '2025-11-29 16:42:21', '2025-12-08 12:50:40'),
...
(439, 25, 'RIC-20251129-001', 0.00, 50.00, 'kg', 44.94, '2025-11-29 16:42:21', '2025-12-13', '', 'Depleted', 'Auto-generated batch', '2025-11-29 16:42:21', '2025-12-06 01:08:01'),
...
(445, 31, 'ONI-20251129-001', 30.00, 50.00, 'kg', 36.22, '2025-11-29 16:42:21', '2025-12-22', '', 'Active', 'Auto-generated batch', '2025-11-29 16:42:21', '2025-12-06 01:08:01'),
...
(469, 55, 'SOY-20251129-001', 35.00, 50.00, 'liter', 44.81, '2025-11-29 16:42:22', '2025-12-23', '', 'Active', 'Auto-generated batch', '2025-11-29 16:42:22', '2025-12-06 01:08:01'),
...
(536, 143, 'BOT-20251129-001', 49.00, 50.00, 'pcs', 43.16, '2025-11-29 16:42:26', '2025-12-13', '', 'Expired', 'Auto-generated batch', '2025-11-29 16:42:26', '2025-12-14 22:14:29'),
...
(541, 148, 'BEE-20251129-001', 49.00, 50.00, 'bucket', 37.65, '2025-11-29 16:42:26', '2025-12-21', '', 'Active', 'Auto-generated batch', '2025-11-29 16:42:26', '2025-12-06 01:50:58'),
...
(196, 12, 426, 'DEDUCT', -50.00, 50.00, 0.00, 'g', 'Website Reservation Confirmed - Beef Teriyaki w/ Egg (Rice Meal)', 'WEBSITE', 2, 'Ronald Sevillaaaaee', NULL, 11, 'RES-11', 'Batch: BEE-20251129-001 | Product: Beef Teriyaki w/ Egg (Rice Meal) (Qty: 1) | Ingredient: Beef', '2025-12-06 01:08:01', 'System'),
(197, 55, 469, 'DEDUCT', -15.00, 50.00, 35.00, 'ml', 'Website Reservation Confirmed - Beef Teriyaki w/ Egg (Rice Meal)', 'WEBSITE', 2, 'Ronald Sevillaaaaee', NULL, 11, 'RES-11', 'Batch: SOY-20251129-001 | Product: Beef Teriyaki w/ Egg (Rice Meal) (Qty: 1) | Ingredient: Soy Sauce', '2025-12-06 01:08:01', 'System'),
(198, 31, 445, 'DEDUCT', -10.00, 40.00, 30.00, 'g', 'Website Reservation Confirmed - Beef Teriyaki w/ Egg (Rice Meal)', 'WEBSITE', 2, 'Ronald Sevillaaaaee', NULL, 11, 'RES-11', 'Batch: ONI-20251129-001 | Product: Beef Teriyaki w/ Egg (Rice Meal) (Qty: 1) | Ingredient: Onion', '2025-12-06 01:08:01', 'System'),
(199, 22, 436, 'DEDUCT', -1.00, 50.00, 49.00, 'pc', 'Website Reservation Confirmed - Beef Teriyaki w/ Egg (Rice Meal)', 'WEBSITE', 2, 'Ronald Sevillaaaaee', NULL, 11, 'RES-11', 'Batch: EGG-20251129-001 | Product: Beef Teriyaki w/ Egg (Rice Meal) (Qty: 1) | Ingredient: Eggs', '2025-12-06 01:08:01', 'System'),
(200, 25, 439, 'DEDUCT', -50.00, 50.00, 0.00, 'g', 'Website Reservation Confirmed - Beef Teriyaki w/ Egg (Rice Meal)', 'WEBSITE', 2, 'Ronald Sevillaaaaee', NULL, 11, 'RES-11', 'Batch: RIC-20251129-001 | Product: Beef Teriyaki w/ Egg (Rice Meal) (Qty: 1) | Ingredient: Rice', '2025-12-06 01:08:01', 'System'),
(201, 22, 436, 'DEDUCT', -1.00, 49.00, 48.00, 'pc', 'Website Reservation Confirmed - Breaded Chicken w/ Egg (Rice Meal)', 'WEBSITE', 2, 'Ronald Sevillaaaaee', NULL, 11, 'RES-11', 'Batch: EGG-20251129-001 | Product: Breaded Chicken w/ Egg (Rice Meal) (Qty: 1) | Ingredient: Eggs', '2025-12-06 01:08:01', 'System'),
(202, 148, 541, 'DEDUCT', -1.00, 50.00, 49.00, 'bucket', 'POS Order - Bucket of Six (Beers)', 'POS', NULL, 'POS User', 1007, NULL, 'ORD-1007', 'Batch: BEE-20251129-001 | Product: Bucket of Six (Beers) (Qty: 1) | Ingredient: Beer Bucket (6 Bottles) | Receipt: ORD-1007', '2025-12-06 01:50:58', 'System'),
(203, 16, 430, 'DEDUCT', -50.00, 50.00, 0.00, 'g', 'Website Reservation Confirmed - Beef Tapa w/ Egg (Rice Meal)', 'WEBSITE', 2, 'Ronald Sevillaaaaee', NULL, 13, 'RES-13', 'Batch: TAP-20251129-001 | Product: Beef Tapa w/ Egg (Rice Meal) (Qty: 1) | Ingredient: Tapa Meat', '2025-12-08 12:50:40', 'System'),
(204, 22, 436, 'DEDUCT', -1.00, 48.00, 47.00, 'pc', 'Website Reservation Confirmed - Beef Tapa w/ Egg (Rice Meal)', 'WEBSITE', 2, 'Ronald Sevillaaaaee', NULL, 13, 'RES-13', 'Batch: EGG-20251129-001 | Product: Beef Tapa w/ Egg (Rice Meal) (Qty: 1) | Ingredient: Eggs', '2025-12-08 12:50:40', 'System');
...
(0, '2025-12-05 22:51:01', 4, 'Login', 'Admin logged in'),
(0, '2025-12-06 00:59:39', 4, 'Login', 'Admin logged in'),
(0, '2025-12-06 01:15:38', 4, 'Login', 'Admin logged in'),
(0, '2025-12-06 01:21:20', 4, 'Login', 'Admin logged in'),
(0, '2025-12-06 01:50:40', 4, 'Login', 'Admin logged in'),
(0, '2025-12-06 23:15:48', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 00:42:43', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 13:54:50', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 13:56:49', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 13:57:24', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 14:07:23', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 14:08:09', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 14:13:23', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 14:18:33', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 14:52:43', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 15:06:04', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 15:11:35', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 15:36:51', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 15:45:51', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 15:48:09', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 15:57:23', 4, 'Login', 'Admin logged in'),
(0, '2025-12-07 16:04:07', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 11:29:34', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 12:26:34', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 13:43:41', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 13:57:03', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 14:01:24', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 14:35:17', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 14:59:41', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 15:29:40', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 15:40:10', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 15:47:14', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 15:56:00', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 16:29:16', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 18:26:48', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 19:35:11', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 19:46:16', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 19:59:10', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 20:00:35', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 20:18:54', 4, 'Login', 'Admin logged in'),
(0, '2025-12-08 20:22:24', 4, 'Login', 'Admin logged in'),
(0, '2025-12-09 16:30:01', 4, 'Login', 'Admin logged in'),
(0, '2025-12-09 21:44:37', 4, 'Login', 'Admin logged in'),
(0, '2025-12-14 21:20:17', 4, 'Login', 'Admin logged in'),
(0, '2025-12-14 22:25:17', 4, 'Login', 'Admin logged in');
...
(1019, NULL, NULL, 'Dine-in', 'POS', NULL, NULL, '2025-12-14', '21:51:34', 2, 295.00, 'Completed', NULL, NULL, NULL, NULL, 0, '2025-12-14 21:51:34', '2025-12-14 22:14:29');
...
--
-- Dumping data for table `order_ingredient_usage`
--

INSERT INTO `order_ingredient_usage` (`UsageID`, `OrderID`, `OrderItemID`, `BatchID`, `IngredientID`, `QuantityUsed`, `UnitType`, `UsageDate`) VALUES
(0, 1019, 27, 536, 143, 1.00, 'pcs', '2025-12-14 22:14:29');
...
(11, 1010, 'Buttered Chicken (Platter)', 1, 250.00, NULL, 'Pending'),
(12, 1011, 'Crispy Pork Sisig w/ Egg (Platter)', 1, 265.00, NULL, 'Pending'),
(13, 1012, 'Crispy Pork Sisig w/ Egg (Platter)', 1, 265.00, NULL, 'Pending'),
(14, 1012, 'Crispy Pork Sisig (Platter 3-4 pax)', 1, 250.00, NULL, 'Pending'),
(15, 1013, 'Calamares (Platter)', 1, 320.00, NULL, 'Pending'),
(16, 1013, 'Lumpiang Shanghai (Platter)', 1, 250.00, NULL, 'Pending'),
(17, 1014, 'Crispy Pork Sisig w/ Egg (Platter)', 1, 265.00, NULL, 'Pending'),
(18, 1014, 'Crispy Pork Sisig (Platter 3-4 pax)', 1, 250.00, NULL, 'Pending'),
(19, 1015, 'Crispy Pork Sisig (Platter 3-4 pax)', 1, 250.00, '', 'Pending'),
(20, 1015, 'Lechon Kawali (Platter)', 1, 350.00, '', 'Pending'),
(21, 1016, 'Crispy Pork Sisig (Platter 3-4 pax)', 1, 250.00, '', 'Pending'),
(22, 1016, 'Calamares (Platter)', 1, 320.00, '', 'Pending'),
(23, 1017, 'Crispy Pork Sisig w/ Egg (Platter)', 1, 265.00, '', 'Pending'),
(24, 1017, 'Buttered Chicken (Platter)', 1, 250.00, '', 'Pending'),
(25, 1018, 'Lumpiang Shanghai (Platter)', 1, 250.00, '', 'Pending'),
(26, 1019, '6 pcs Pork BBQ w/ Butter Veg. (Platter)', 1, 270.00, NULL, 'Pending'),
(27, 1019, 'Bottled Water', 1, 25.00, NULL, 'Pending');
...
CREATE TABLE `payments` (
  ...
  `ProofOfPayment` varchar(255) DEFAULT NULL COMMENT 'Path to uploaded payment receipt image',
...
INSERT INTO `payments` (`PaymentID`, `OrderID`, `PaymentDate`, `PaymentMethod`, `PaymentStatus`, `AmountPaid`, `PaymentSource`, `ProofOfPayment`, `ReceiptFileName`, `TransactionID`, `Notes`) VALUES
(1, 1000, '2025-11-23 12:46:04', 'COD', 'Pending', 345.00, 'Website', NULL, NULL, NULL, NULL),
(0, 1010, '2025-12-07 00:42:12', 'COD', 'Pending', 250.00, 'Website', NULL, NULL, NULL, NULL),
(0, 1011, '2025-12-08 11:27:39', 'COD', 'Pending', 265.00, 'Website', NULL, NULL, NULL, NULL),
(0, 1012, '2025-12-08 11:40:46', 'GCash', 'Pending', 515.00, 'Website', NULL, NULL, NULL, NULL),
(0, 1013, '2025-12-08 12:16:06', 'COD', 'Pending', 570.00, 'Website', NULL, NULL, NULL, NULL),
(0, 1014, '2025-12-08 14:13:28', 'COD', 'Pending', 515.00, 'Website', NULL, NULL, NULL, NULL),
(0, 1015, '2025-12-08 14:34:43', 'GCash', 'Pending', 600.00, 'Website', 'uploads/order_receipts/2025/12/order_7_1765175683_9571.jpg', 'order_7_1765175683_9571.jpg', NULL, 'GCash receipt uploaded'),
(0, 1016, '2025-12-08 14:43:55', 'GCash', 'Pending', 570.00, 'Website', 'uploads/order_receipts/2025/12/order_7_1765176235_8498.jpg', 'order_7_1765176235_8498.jpg', NULL, 'GCash receipt uploaded'),
(0, 1017, '2025-12-08 14:48:41', 'GCash', 'Pending', 515.00, 'Website', 'uploads/order_receipts/2025/12/order_7_1765176521_7584.jpg', 'order_7_1765176521_7584.jpg', NULL, 'GCash receipt uploaded'),
(0, 1018, '2025-12-08 16:28:48', 'GCash', 'Pending', 250.00, 'Website', 'uploads/order_receipts/2025/12/order_2_1765182528_8544.jpg', 'order_2_1765182528_8544.jpg', NULL, 'GCash receipt uploaded');
...
(1, 2, '2025-11-01', '2025-11-15', 9.00, 100.00, 800.00, 150.00, 0.00, 0.00, 'Pending', NULL, NULL, NULL, '2025-11-29 19:09:07'),
(2, 5, '2025-12-01', '2025-12-31', 7.00, 62.50, 10.00, 0.00, 0.00, 0.00, 'Paid', NULL, '2025-12-09 21:49:19', NULL, '2025-12-09 21:47:47');
...
(4, 2, 'Canned Soft Drink (Coke | Royal | Sprite | Mt. Dew)', 21, 1, 45.00, 45.00, 'N/A', 1, 'DRINKS & BEVERAGES', 'Single', '2025-12-04 18:21:14', NULL),
(5, 3, 'Canned Soft Drink (Coke | Royal | Sprite | Mt. Dew)', 21, 1, 45.00, 45.00, 'N/A', 1, 'DRINKS & BEVERAGES', 'Single', '2025-12-04 18:25:03', NULL),
(6, 4, 'Bottled Water', 22, 1, 25.00, 25.00, 'N/A', 1, 'DRINKS & BEVERAGES', 'Single', '2025-12-04 18:31:06', NULL),
(7, 5, 'Bottled Water', 22, 1, 25.00, 25.00, 'N/A', 1, 'DRINKS & BEVERAGES', 'Single', '2025-12-04 19:38:22', NULL),
(8, 6, 'Bottled Water', 22, 1, 25.00, 25.00, 'N/A', 1, 'DRINKS & BEVERAGES', 'Single', '2025-12-04 23:46:57', NULL),
(9, 7, '6 pcs Pork BBQ w/ Butter Veg. (Platter)', 45, 1, 270.00, 270.00, 'N/A', 1, 'PLATTER', 'Single', '2025-12-14 21:51:34', NULL),
(10, 7, 'Bottled Water', 22, 1, 25.00, 25.00, 'N/A', 1, 'DRINKS & BEVERAGES', 'Single', '2025-12-14 21:51:34', NULL);
...
(5, 8, NULL, NULL, 'Online', 'anniversary', '2025-11-22', '19:00:00', 50, 'Shrimp & Squid Kare Kare (Platter) x1', 'no more sugar', 'Confirmed', '2025-11-22 22:37:24', '', 'Pickup', '09511299476', '2025-12-14 22:26:36'),
...
(8, 2, NULL, NULL, 'Online', 'birthday', '2025-11-28', '16:00:00', 50, 'Pork Tocino w/ Egg (Rice Meal) x26', '', 'Confirmed', '2025-11-28 23:32:29', '', 'Pickup', '09511299476', '2025-12-06 00:31:07'),
(9, 2, NULL, NULL, 'Online', 'birthday', '2025-11-30', '15:00:00', 50, 'Sizzling Spicy Squid (Platter) x1, Chopsuey (Platter) x1', '', 'Pending', '2025-12-01 00:11:01', '', 'Pickup', '09511299476', '2025-12-06 00:31:07'),
(10, 2, NULL, NULL, 'Online', 'birthday', '2025-11-30', '14:00:00', 50, 'Lumpiang Shanghai (Platter) x1, Buttered Chicken (Platter) x1', '', 'Confirmed', '2025-12-01 00:21:32', '', 'Pickup', '09511299476', '2025-12-06 01:48:14'),
(11, 2, NULL, NULL, 'Online', 'birthday', '2025-12-05', '19:00:00', 47, 'Beef Steak Tagalog (Platter) x1, Sizzling Spicy Squid (Platter) x1, Bicol Express (Platter) x1, Beef Teriyaki w/ Egg (Rice Meal) x1, Breaded Chicken w/ Egg (Rice Meal) x1', '', 'Confirmed', '2025-12-06 01:07:16', '', 'Pickup', '09511299476', '2025-12-06 01:08:01'),
(12, 2, NULL, NULL, 'Online', 'anniversary', '2025-12-05', '18:00:00', 44, 'Buttered Chicken (Platter) x1, Calamares (Platter) x1, Fried Lumpia Veg. (12 PCS) (Platter) x1', '', 'Confirmed', '2025-12-06 01:58:58', '', 'Pickup', '09511299476', '2025-12-06 01:59:31'),
(13, 2, NULL, NULL, 'Online', 'anniversary', '2025-12-08', '16:00:00', 44, 'Beef Tapa w/ Egg (Rice Meal) x1', '', 'Confirmed', '2025-12-08 11:15:55', '', 'Pickup', '09511299476', '2025-12-08 12:50:40'),
(14, 2, NULL, NULL, 'Online', 'anniversary', '2025-12-08', '19:00:00', 50, 'Calamares (Platter) x1', '', 'Pending', '2025-12-08 13:25:54', '', 'Pickup', '09511299476', '2025-12-08 13:25:54'),
(15, 7, NULL, NULL, 'Online', 'anniversary', '2025-12-08', '18:00:00', 50, 'Sizzling Tofu (Platter) x1, Shrimp Sinigang (Platter) x1', '', 'Confirmed', '2025-12-08 13:29:45', '', 'Pickup', '09512994765', '2025-12-08 15:43:02');
...
(15, 11, 'Beef Steak Tagalog (Platter)', 1, 340.00, 340.00),
(16, 11, 'Sizzling Spicy Squid (Platter)', 1, 360.00, 360.00),
(17, 11, 'Bicol Express (Platter)', 1, 260.00, 260.00),
(18, 11, 'Beef Teriyaki w/ Egg (Rice Meal)', 1, 125.00, 125.00),
(19, 11, 'Breaded Chicken w/ Egg (Rice Meal)', 1, 100.00, 100.00),
(20, 12, 'Buttered Chicken (Platter)', 1, 250.00, 250.00),
(21, 12, 'Calamares (Platter)', 1, 320.00, 320.00),
(22, 12, 'Fried Lumpia Veg. (12 PCS) (Platter)', 1, 145.00, 145.00),
(23, 13, 'Beef Tapa w/ Egg (Rice Meal)', 1, 110.00, 110.00),
(24, 14, 'Calamares (Platter)', 1, 320.00, 320.00),
(25, 15, 'Sizzling Tofu (Platter)', 1, 180.00, 180.00),
(26, 15, 'Shrimp Sinigang (Platter)', 1, 350.00, 350.00);
...
(7, 7, '2025-11-23 12:32:49', 'GCash', 'Completed', 260.00, 'Website', 'uploads/gcash_receipts/2025/11/receipt_8_1763872369_2130.jpg', 'receipt_8_1763872369_2130.jpg', NULL, '2025-12-08 15:49:39'),
(0, 0, '2025-11-28 23:32:29', 'GCash', 'Completed', 2730.00, 'Website', 'uploads/gcash_receipts/2025/11/receipt_2_1764343949_4937.jpg', 'receipt_2_1764343949_4937.jpg', NULL, '2025-12-08 15:49:25'),
(0, 0, '2025-12-01 00:11:01', 'GCash', 'Completed', 610.00, 'Website', 'uploads/gcash_receipts/2025/11/receipt_2_1764519061_4699.jpg', 'receipt_2_1764519061_4699.jpg', NULL, '2025-12-08 15:49:25'),
(0, 0, '2025-12-01 00:21:33', 'GCash', 'Completed', 500.00, 'Website', 'uploads/gcash_receipts/2025/11/receipt_2_1764519692_5081.jpg', 'receipt_2_1764519692_5081.jpg', NULL, '2025-12-08 15:49:25'),
(0, 11, '2025-12-06 01:07:16', 'GCash', 'Completed', 1185.00, 'Website', 'uploads/gcash_receipts/2025/12/receipt_2_1764954436_9365.jpg', 'receipt_2_1764954436_9365.jpg', NULL, '2025-12-08 15:49:25'),
(0, 12, '2025-12-06 01:58:59', 'GCash', 'Completed', 715.00, 'Website', 'uploads/gcash_receipts/2025/12/receipt_2_1764957538_6127.jpg', 'receipt_2_1764957538_6127.jpg', NULL, '2025-12-08 15:49:25'),
(0, 13, '2025-12-08 11:15:55', 'GCash', 'Completed', 110.00, 'Website', 'uploads/gcash_receipts/2025/12/receipt_2_1765163755_6624.jpg', 'receipt_2_1765163755_6624.jpg', NULL, '2025-12-08 15:49:25'),
(0, 14, '2025-12-08 13:25:54', 'GCash', 'Completed', 320.00, 'Website', 'uploads/gcash_receipts/2025/12/receipt_2_1765171554_5254.jpg', 'receipt_2_1765171554_5254.jpg', NULL, '2025-12-08 15:49:25'),
(0, 15, '2025-12-08 13:29:45', 'GCash', 'Completed', 530.00, 'Website', 'uploads/gcash_receipts/2025/12/receipt_7_1765171785_9154.jpg', 'receipt_7_1765171785_9154.jpg', NULL, '2025-12-08 15:49:25');
...
INSERT INTO `sales_receipts` (`ReceiptID`, `OrderNumber`, `ReceiptDate`, `ReceiptTime`, `EmployeeID`, `CashierName`, `CustomerID`, `CustomerName`, `CustomerType`, `Subtotal`, `TaxAmount`, `DiscountAmount`, `TotalAmount`, `PaymentMethod`, `AmountGiven`, `ChangeAmount`, `TransactionStatus`, `OrderSource`, `CreatedDate`, `UpdatedDate`) VALUES
(1, 'VT-2025-001238', '2025-11-27', '11:32:00', NULL, 'Staff 01', NULL, 'Walk-in Customer', 'Walk-in', 225.00, 27.00, 0.00, 252.00, 'CASH', 300.00, 48.00, 'Completed', 'POS', '2025-11-27 11:32:00', '2025-12-04 18:19:34'),
(2, 'VT-2025-001010', '2025-12-04', '18:21:14', NULL, 'POS Cashier', NULL, 'Walk-in Customer', 'Walk-in', 45.00, 0.00, 0.00, 45.00, 'CASH', 100.00, 55.00, 'Completed', 'POS', '2025-12-04 18:21:14', '2025-12-04 18:21:14'),
(3, 'VT-2025-001011', '2025-12-04', '18:25:03', NULL, 'POS Cashier', NULL, 'Walk-in Customer', 'Walk-in', 45.00, 0.00, 0.00, 45.00, 'CASH', 50.00, 5.00, 'Completed', 'POS', '2025-12-04 18:25:03', '2025-12-04 18:25:03'),
(4, 'VT-2025-001012', '2025-12-04', '18:31:06', NULL, 'POS Cashier', NULL, 'Walk-in Customer', 'Walk-in', 25.00, 0.00, 0.00, 25.00, 'CASH', 50.00, 25.00, 'Completed', 'POS', '2025-12-04 18:31:06', '2025-12-04 18:31:06'),
(5, 'VT-2025-001013', '2025-12-04', '19:38:22', NULL, 'POS Cashier', NULL, 'Walk-in Customer', 'Walk-in', 25.00, 0.00, 0.00, 25.00, 'CASH', 100.00, 75.00, 'Completed', 'POS', '2025-12-04 19:38:22', '2025-12-04 19:38:22'),
(6, 'VT-2025-001014', '2025-12-04', '23:46:57', NULL, 'POS Cashier', NULL, 'Walk-in Customer', 'Walk-in', 25.00, 0.00, 0.00, 25.00, 'CASH', 50.00, 25.00, 'Completed', 'POS', '2025-12-04 23:46:57', '2025-12-04 23:46:57'),
(7, 'VT-2025-001019', '2025-12-14', '21:51:34', NULL, 'POS Cashier', NULL, 'Walk-in Customer', 'Walk-in', 295.00, 0.00, 0.00, 295.00, 'CASH', 500.00, 205.00, 'Completed', 'POS', '2025-12-14 21:51:34', '2025-12-14 21:51:34');
...
--
-- Structure for view `approved_feedback_view`
--
DROP TABLE IF EXISTS `approved_feedback_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `approved_feedback_view`  AS SELECT `cf`.`FeedbackID` AS `FeedbackID`, `cf`.`CustomerID` AS `CustomerID`, CASE WHEN `cf`.`IsAnonymous` = 1 THEN 'Anonymous' ELSE concat(`c`.`FirstName`,' ',left(`c`.`LastName`,1),'.') END AS `DisplayName`, `cf`.`OrderID` AS `OrderID`, `cf`.`ReservationID` AS `ReservationID`, `cf`.`FeedbackType` AS `FeedbackType`, `cf`.`OverallRating` AS `OverallRating`, `cf`.`FoodTasteRating` AS `FoodTasteRating`, `cf`.`PortionSizeRating` AS `PortionSizeRating`, `cf`.`ServiceRating` AS `ServiceRating`, `cf`.`AmbienceRating` AS `AmbienceRating`, `cf`.`CleanlinessRating` AS `CleanlinessRating`, `cf`.`FoodTasteComment` AS `FoodTasteComment`, `cf`.`PortionSizeComment` AS `PortionSizeComment`, `cf`.`ServiceComment` AS `ServiceComment`, `cf`.`AmbienceComment` AS `AmbienceComment`, `cf`.`CleanlinessComment` AS `CleanlinessComment`, `cf`.`ReviewMessage` AS `ReviewMessage`, `cf`.`CreatedDate` AS `CreatedDate`, `cf`.`ApprovedDate` AS `ApprovedDate` FROM (`customer_feedback` `cf` join `customers` `c` on(`cf`.`CustomerID` = `c`.`CustomerID`)) WHERE `cf`.`Status` = 'Approved' ORDER BY `cf`.`CreatedDate` DESC ;
...
ALTER TABLE `customer_feedback`
  ...
  ADD KEY `idx_reservation` (`ReservationID`),
...
ALTER TABLE `employee_attendance`
  ...
  ADD KEY `IDX_EmployeeDate` (`EmployeeID`,`AttendanceDate`);
...
--
ALTER TABLE `customer_feedback`
  MODIFY `FeedbackID` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Unique feedback identifier', AUTO_INCREMENT=4;
...
--
ALTER TABLE `employee_attendance`
  MODIFY `AttendanceID` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Unique attendance record identifier', AUTO_INCREMENT=6;
...
--
ALTER TABLE `inventory_movement_log`
  MODIFY `MovementID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `OrderID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1020;

--
-- AUTO_INCREMENT for table `order_items`
--
ALTER TABLE `order_items`
  MODIFY `OrderItemID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `receipt_items`
  MODIFY `ReceiptItemID` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Unique receipt item identifier', AUTO_INCREMENT=11;
...
--
ALTER TABLE `reservation_items`
  MODIFY `ReservationItemID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `sales_receipts`
--
ALTER TABLE `sales_receipts`
  MODIFY `ReceiptID` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Unique receipt identifier', AUTO_INCREMENT=8;
...
--
ALTER TABLE `customer_feedback`
  ADD CONSTRAINT `fk_feedback_order` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`) ON DELETE SET NULL;

--
-- Constraints for table `employee_attendance`
--
ALTER TABLE `employee_attendance`
  ADD CONSTRAINT `FK_Attendance_Employee` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`EmployeeID`) ON DELETE CASCADE ON UPDATE CASCADE;
