...
Public Class PlaceOrderForm
    ...
    Private Function CreateProductPanel(product As Product) As Panel
        ...
        If Not String.IsNullOrEmpty(product.Image) Then
            Try
                ' Extract just the filename from the database path (e.g., "uploads/products/image.jpg" -> "image.jpg")
                Dim filename As String = Path.GetFileName(product.Image)
                
                ' Build the full path to the actual image location
                Dim imagePath As String = Path.Combine("C:\xampp\htdocs\products_image\products", filename)
    ...
    Private Sub btnPlatter_Click(sender As Object, e As EventArgs) Handles btnPlatter.Click
        LoadProducts("Platter") ' Ensure DB category matches
    ...
    Private Sub btnDessert_Click(sender As Object, e As EventArgs) Handles btnDessert.Click
        LoadProducts("DESSERT")
        HighlightCategoryButton(btnDessert)
    End Sub

    Private Sub btnRiceMeal_Click(sender As Object, e As EventArgs) Handles btnRiceMeal.Click
        LoadProducts("RICE MEAL")
    ...
    Private Sub btnDrinksAndBeverages_Click(sender As Object, e As EventArgs) Handles Button2.Click
        LoadProducts("DRINKS & BEVERAGES")
        HighlightCategoryButton(Button2)
    End Sub

    Private Sub btnBilao_Click(sender As Object, e As EventArgs) Handles Button3.Click
        LoadProducts("BILAO")
